...
<head>
    ...
    <title>@yield('pagetitle',Lang::get('dassaultlean.'.'title'))</title>
    <link rel="stylesheet" href="{{ asset('bundle/'.$manifest['dassaultlean'][0])}}">
...
<body class="min-h-screen font-sans font-light leading-normal">
    ...
    @section('pagescript')
	<script src="{{ asset('bundle/'.$manifest['dassaultlean'][1])}}"></script>
