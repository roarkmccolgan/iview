				...
				<tr>
					<td>
						...
						<table>
							<tr>
								<td class="padding">
									<p><a href="{{ session('url').'/'.session('locale').'/idc/pdf?uuid='.$assessment->uuid.'&utm='.$assessment->code }}" class="btn-primary" style="color:#FFF">{{trans(session('product.alias').'.email.link')}}</a></p>
								</td>
							</tr>
							@if(isset($inline) && $inline!=false)
							<tr>
								<td class="padding">
									<p><a href="{{ session('url').'/'.session('locale').'/idc/pdf?uuid='.$assessment->uuid.'&utm='.$assessment->code.'&browser=true' }}" class="btn-primary" style="color:#FFF">{{trans(session('product.alias').'.email.link_inline')}}</a></p>
								</td>
							</tr>
							@endif
						</table>
