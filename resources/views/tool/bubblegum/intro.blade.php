            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-sm-6 col-sm-push-5">
                        <div class="mt--3">
                            <h1>{{Lang::get('general.'.session('product.id').'title')}}<br/><small>{{Lang::get('general.'.session('product.id').'sub-title')}}</small></h1>
                            <p class="lead">{!!Lang::get('general.'.session('product.id').'landing')!!}</p>
                            <hr class="short">
                    ...
                    <div class="col-sm-3 col-sm-pull-6 col-sm-offset-1 text-center">
                        <div class="mt--3">
                            <div class="hero">
                                <i class="icon icon-Security-Check"></i> </div>    
                            </div>
                        </div>
                </div>
            </div>
