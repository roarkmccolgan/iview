                ...
                <div id="results" style="background-color: #FFF; padding: 20px; padding-top: 40px;">
                    ...
                    {{ Form::open(array('url' => '/'.session('locale').'/quiz/complete','id'=>'form-email-report','class'=>'clearfix')) }}
                        <fieldset>
                            ...
                            <div class="col-md-6 form-group{{$errors->has('fname')?' error':''}}">
                            ...
                            <div class="col-md-6 form-group{{$errors->has('sname')?' error':''}}">
                            ...
                            <div class="col-md-6 form-group{{$errors->has('email')?' error':''}}">
                            ...
                            <div class="col-md-6 form-group{{$errors->has('company')?' error':''}}">
