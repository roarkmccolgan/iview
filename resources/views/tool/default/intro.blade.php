            ...
            <div class="splash">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-0 col-xs-4 col-xs-offset-4 action">
                        <a href="{{'/'.session('locale').'/quiz/'.Session::get('startSection').'/page1'}}" class="startbut btn btn-primary btn-lg">{{Lang::get('general.'.$tool->id.'startbut')}} &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-right"></i></a>
                    </div>
