...
<div class="clearfix text-white bg-blackblack py-2 {{ App::environment('local') ? 'pt-4 text-sm' : 'py-6'}}">
	<div class="w-5/6 mx-auto flex items-center justify-between">
		<div class="whitespace-no-wrap">
			<strong>{{ trans('sapagileglobal.title') }}</strong> - {{ trans('sapagileglobal.sub-title') }}
		</div>
		<div class="text-right flex items-center">
			<div class="mr-12 text-gray-200 whitespace-no-wrap">sponsored by</div>
			<img class="" src="{{ asset('images/tools/17/SAP_logo.svg')}}" alt="" style="width: 20.948mm; height: 10.363mm" />
		</div>
	</div>
</div>
</body>
