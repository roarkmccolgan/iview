...
<head>
    ...
    <title>@yield('pagetitle',Lang::get('sapagileglobal.'.'title'))</title>
    <link rel="stylesheet" href="https://use.typekit.net/stp0zch.css">
...
<body class="min-h-screen font-sans font-light leading-normal">
    ...
    @section('pagescript')
	<script src="{{ asset('bundle/'.$manifest['sapagileglobal'][1])}}"></script>
