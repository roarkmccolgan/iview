...
<head>
    ...
    <link href="/fonts/gilroy-bold-cufonfonts-webfont/style.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('bundle/'.$manifest['snow'][0])}}">
...
<body class="min-h-screen font-sans leading-normal">
    @yield('main')
    
    @include('_layouts.footer')
    @section('pagescript')
	<script src="{{ asset('bundle/'.$manifest['snow'][1])}}"></script>
	@show
</body>
</html>
