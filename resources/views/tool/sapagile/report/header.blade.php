...
<body onload="subst()">
<div class="swopimage w-full text-white bg-center bg-cover bg-no-repeat overflow-hidden bg-blackblack" style="height: 21mm;">
	<div class="w-5/6 mx-auto">
		<h1 class="section font-thin uppercase text-xl pt-6">Hey</h1>
