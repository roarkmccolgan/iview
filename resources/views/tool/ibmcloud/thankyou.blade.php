	...
	<div class="bg-blackblack">
	    <div class="container mx-auto px-4 flex items-center justify-between">
    		...
    		<div class="text-right text-white">
    			<img src="{{ asset('images/tools/16/ibmcloud_logo.svg') }}" class="w-32 sm:w-38" alt="">
	    	</div>
	    </div>
	</div>
	<div class="flex-grow">
		<div class="container mx-auto flex flex-wrap items-center mb-4 py-12 sm:py-20 bg-no-repeat bg-cover bg-right-bottom" :style="`background-image: url('/images/tools/13/cloud-ser-hero-banner-desk.jpg');`">
