...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('bundle/'.$manifest['redhat'][0])}}">
...
<body class="min-h-screen font-redhat font-light leading-normal">
    @yield('main')
    
    @include('_layouts.footer')
    @section('pagescript')
	<script src="{{ asset('bundle/'.$manifest['redhat'][1])}}"></script>
	@show
</body>
</html>
