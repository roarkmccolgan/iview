...
<div id="app" class="h-screen flex flex-col">
	<div class="bg-blackblack">
	    <div class="container mx-auto px-4 flex items-center justify-between">
    		...
    		<div class="text-right text-white">
    			<img src="{{ asset('images/tools/19/redhat_logo.svg') }}" class="w-32 sm:w-40" alt="">
	    	</div>
	    </div>
	</div>
	<div class="flex-grow">
		...
		<div class="container mx-auto bg-white border-t border-b p-8 sm:border shadow text-grey-darker">
			<div>
				<h2 class="font-bold mb-4 text-redhat leading-tight">{{ $heading }}</h2>
				<p class="mb-2">
					{!! $body !!}
				</p>
			</div>
	...
	<div class="container mx-auto bg-white border-t border-b mt-6 mb-4 py-4 px-4 sm:border sm:rounded text-grey-darker">
		<div class="flex justify-start">
			<div class="mr-2 pr-2 border-r text-sm"><a href="/disclaimer" target="_blank" class="no-underline text-black opacity-75">@lang('general.disclaimer')</a></div>
			<div class="mr-2 pr-2 border-r text-sm"><a href="/privacy" target="_blank" class="no-underline text-black opacity-75">@lang('general.idcprivacy')</a></div>
			<div class="mr-2 pr-2 border-r text-sm"><a href="/cookies" target="_blank" class="no-underline text-black opacity-75">@lang('general.cookiespolicylink')</a></div>
		</div>
	</div>
</div>
@stop
