		...
		<footer class="footer">
			<div class="container">
				...
				<div class="col-sm-5 text-right">
					<span class="assoc">{{Lang::get('general.'.session('product.id').'assoc')}} <img class="sponsor" src="{{asset('images/tools/'.session('product.id').'/fireeye_dxc.png')}}" alt="{{Lang::get('general.'.session('product.id').'sponsor')}}"></span>
				</div>	
                		</div>
                	</div>
                </div>
