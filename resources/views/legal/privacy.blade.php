...
<p>
By visiting [<a href="{{ url('/') }}">{{ url('/') }}</a>] ("<strong>Website</strong>") you are accepting and consenting to the practices described in this policy and you agree to this transfer, storing or processing. We will take all steps reasonably necessary to ensure that your personal data is treated securely and in accordance with this privacy policy.
</p>
<p>
...
<p>
For detailed information on the cookies we use and the purposes for which we use them see our <a href="{{url('/cookies')}}">Cookie policy</a>.
</p>
<h3>Web Beacons</h3>
<p>
