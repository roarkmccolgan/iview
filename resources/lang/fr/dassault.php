...
return [
    ...
    'further-insight' => 'Plus d\'informations',
    'accellerating-success' => 'Accélérer le succès de l\'ingénierie numérique des start-ups et des PME avec le cloud',
    'a-video' => 'Une vidéo par IDC',
    'how-the-wan' => 'Infobrief sur la maturité numérique',
    'an-infbrief' => 'Un Infobrief par IDC',
    'driver-of' => 'Informations sur la maturité numérique',
    'an-infographic' => 'Une information par IDC',
    'an-infographic-sub' => 'Découvrez comment les autres membres de votre marché se classent.',
    'download-now' => 'Télécharger',
    'view-now' => 'Afficher',
    'title' => 'Livraison numérique',
    'sub-title' => 'Quelle est la maturité numérique de votre entreprise ?',
    'landing'=>'
        <h1 class="font-bold mb-2 leading-none">Prêt pour la transformation numérique de votre entreprise ?</h1>
        <p class="mb-2">
            Start-ups et PMEs, adoptez une plateforme cloud et renforcez ainsi votre crédibilité auprès de vos clients, investisseurs et partenaires. Vous pourrez ainsi attirer et de fidéliser des personnes clés, mais aussi innover de façon plus rentable et durable.
        </p>
        <p class="mb-2">
            En bref, les plateformes cloud pour la conception et l’ingénierie numériques rendent possible une innovation numérique, tout en projetant votre entreprise à un autre niveau.
        </p>
        <ul class="font-bold mb-4">
            <li class="list-none">Mais où en êtes-vous dans ce cheminement?</li>
            <li class="list-none">Comment utilisez-vous les technologies numériques pour accélérer la croissance et bousculer votre industrie?</li>
            <li class="list-none">Quel est votre positionnement par rapport à la concurrence et où prendre l’initiative ?</li>
        </ul>
        <p class="mb-2">
            Ce benchmark de maturité numérique IDC, créée en partenariat avec Dassault Systèmes, répond à ces questions.
        </p>
        <p class="mb-2">
            Répondez une courte série de questions et découvrez ainsi votre positionnement face à vos pairs et à des organisations similaires à la vôtre, que ce soit au niveau digital, conception et prestation de services cloud. Ce rapport vous sera ensuite présenté de manière simple, vous permettant d’identifier vos points forts vos points faibles et les axes d’amélioration pour développer la croissance de votre entreprise et garder de l’avance sur la concurrence.
        </p>
        <p class="font-bold">
    ...
    'size6' => '250 à 499',
    'size7' => '500 à 999',
    'industry1' => 'Banque/assurances/services financiers',
    'industry2' => 'Fabrication',
    'industry3' => 'Vente au détail/en gros',
    'industry4' => 'Communication',
    'industry5' => 'Médias (télévision, radio, presse)',
    'industry6' => 'Services publics',
    'industry7' => 'Transport',
    'industry8' => 'Construction',
    'industry9' => 'Services personnels/loisirs',
    'industry10' => 'Services professionnels (immobilier, comptabilité, publicité, conseils aux entreprises, recrutement, etc.)',
    'industry11' => 'Prestataires de services informatiques/de télécommunications',
    'industry12' => 'Éducation',
    'industry13' => 'Santé',
    'stage1' => 'Novice numérique',
    'stage2' => 'Spécialiste du numérique',
    'stage3' => 'Natif numérique',
    'stage1-finish' => 'L\'ensemble de vos réponse indique que vous vous classez en tant que <strong class="text-ntt-data-yellow">DX Complacent</strong>, qui est le niveau d\'entrée de cette évaluation.',
    'stage2-finish' => 'L\'ensemble de vos réponse indique que vous vous classez en tant que <strong class="text-ntt-data-yellow">DX Conformist</strong>, qui est le niveau intermédiaire de cette évaluation.',
    ...
    'finishtxtheading' => '
        Merci d\'avoir rempli le test de maturité numérique d\'IDC.
    ',
       'finishtxt1' => 'L\'ensemble de vos réponse indique que vous vous classez comme',
       'finishtxtstage1' => '
        qui est le niveau le plus bas sur trois dans cette évaluation.
    ',
       'finishtxtstage2' => '
        qui est le deuxième niveau sur trois de cette évaluation.
    ',
       'finishtxtstage3' => '
        qui est le niveau le plus élevé sur trois de cette évaluation.
    ',
    'finishtxt2' => '
        <p class="mb-2 mt-4">Souhaitez-vous obtenir le rapport complet, qui vous fournit des principes essentiels pour progresser dans votre parcours de maturité numérique ?</p>
        <p class="mb-4">Nous pouvons vous l\'envoyer directement dans votre messagerie. Il vous suffit de nous fournir vos coordonnées et nous vous les enverrons.</p>
    ',
    ...
    'email'=>[
        ...
        'hi' => 'Bonjour :Fname',
        'body' => 'Comme promis, voici un lien pour télécharger votre rapport d\'évaluation de la maturité numérique de Dassault Systèmes.',
    ...
    'introduction' => '
        ...
        <p class="mb-6">La maturité numérique est essentielle pour la réussite des start-ups et des PME d\'aujourd\'hui. La concurrence dans l\'économie mondiale pour les clients, les investissements et les talents nécessite un accès instantané aux applications et ressources informatiques de classe mondiale, qui évoluent au rythme de votre réussite. Le cloud offre cette flexibilité et cette évolutivité qui contribuent à la réussite de l\'entreprise numérique et démocratise l\'accès à une technologie de classe mondiale, la rendant disponible et abordable pour les start-ups et les PME. Pour évaluer la maturité numérique des start-ups et PME, IDC a mené une enquête auprès de 400 organisations en Allemagne, en France, au Royaume-Uni et aux États-Unis afin de comprendre comment les applications de conception et d\'ingénierie numériques sont utilisées dans les start-ups et les PME. D\'après les résultats, nous avons regroupé les personnes interrogées en trois catégories : perfectionnement numérique, spécialiste du numérique et natif numérique, afin de comprendre ce qui distingue les leaders de la maturité numérique de leurs concurrents et les meilleures pratiques que nous pouvons leur appliquer.</p>
        
        <h2 class="text-dassault-blue mb-4">POINTS FORTS DE L\'ENQUÊTE</h2>
        <p class="mb-4">Selon l\'enquête, les principales priorités pour les start-ups et PME les plus importantes sont liées à la rentabilité. Elles souhaitent améliorer leur rentabilité ou devenir rentables, en fonction de l\'âge et du stade de développement de l\'entreprise. La gestion de la rentabilité nécessite un bon équilibre entre la réalisation des investissements nécessaires pour stimuler l\'innovation et la maîtrise des coûts. L\'alignement des priorités commerciales et informatiques et le soutien de la stratégie d\'entreprise avec un modèle de prestation informatique flexible favorisent la transition vers la rentabilité. Les priorités supplémentaires sont l\'augmentation de la notoriété de la marque et l\'accélération du délai de mise sur le marché. L\'utilisation des applications et outils informatiques les plus récents permet d\'attirer les talents et de créer une expérience exceptionnelle pour les employés, les clients et les partenaires, ce qui contribue à améliorer la notoriété de la marque. L\'accélération du délai de mise sur le marché s\'effectue généralement en travaillant avec des méthodes souples, en peu de temps et en obtenant rapidement un retour d\'informations sur le marché. Une plate-forme numérique basée sur le cloud peut faciliter la collaboration entre des employés géographiquement dispersés, mais également dans l\'écosystème de clients, de partenaires et de fournisseurs.</p>
    ...
    ',
    'overallintro'=>'
        <h2 class="text-dassault-blue mb-6">CLASSEMENT GLOBAL</h2>
        <p class="mb-2">
            Les start-ups et les PME ne peuvent rivaliser avec succès dans l\'économie mondiale qu\'en s\'adaptant numériquement et en tirant parti des technologies numériques telles que la conception numérique et les applications d\'ingénierie fournies par le cloud. L\'outil d\'évaluation de la maturité numérique d\'IDC note les start-ups et les PME sur leur maturité numérique en étudiant trois éléments clés : l\'entreprise numérique, la conception numérique et la livraison numérique. 
        </p>
    ',
    'overallstage1'=>'
        <div class="clearfix">
            <p class="mb-2 text-dassault-blue mt-4 font-bold">
                Vous êtes au début de votre parcours numérique. D\'après vos réponses au test maturité numérique d\'IDC, votre entreprise a été évaluée au niveau débutant des trois niveaux de maturité numérique :  Novice numérique.
            </p>
            <p class="mb-2 text-dassault-blue mt-4 font-bold">
                Cela signifie que vous n\'en n\'êtes qu\'à vos premiers pas vers un avenir numérique par rapport au reste de l\'industrie et qu\'il vous reste encore beaucoup à faire pour être là où vous devez être afin d\'être compétitif efficacement à long terme.
            </p>
        </div>
    ',
    'overallstage2'=>'
        <div class="clearfix">
            <p class="mb-2 text-dassault-blue mt-4 font-bold">
                Vous êtes en bonne voie pour votre parcours numérique. D\'après vos réponses au test de maturité numérique d\'IDC, votre entreprise a été évaluée au deuxième plus haut niveau de maturité numérique : Spécialiste du numérique. Cela signifie que votre entreprise est généralement en phase avec le reste du secteur et se prépare à l\'avenir du numérique. Bien que vous vous en sortiez bien, il reste encore beaucoup à faire pour être entièrement prêt pour le numérique.
            </p>
        </div>
    ',
    'overallstage3'=>'
        <div class="clearfix">
            <p class="mb-2 text-dassault-blue mt-4 font-bold">
                Félicitations ! D\'après vos réponses au test de maturité numérique d\'IDC, votre entreprise a été évaluée au plus haut niveau de maturité numérique : Natif numérique. Cela signifie que votre organisation est généralement en avance sur l\'industrie et ouvre la voie de l\'avenir numérique. Gardez toujours à l\'esprit que vous devez continuer à travailler pour garder une longueur d\'avance sur la concurrence !
            </p>
        </div>
    ',
    'overallgraph'=>'
    ...
    ',
    'comparisongraph'=>'
    <div class="mb-2 text-dassault-blue mt-4 font-bold border-b">Comment vous comparez à vos pairs</div>
    <div class="mx-auto my-4">:graph</div>
    ',
    'overalloutrostage1' => '
        <div class="clearfix">
            <p class="mb-2">
                Vos résultats indiquent qu\'il existe de nombreux domaines que vous pouvez aborder pour améliorer votre maturité numérique. Ce rapport vous donnera des conseils sur les domaines à privilégier lorsque vous vous pencherez sur l\'étape suivante de la maturité numérique. Passons à la page suivante et penchons-nous sur ce que vous pouvez faire.
            </p>
        </div>
        <div class="pb"></div>
    ',
    'overalloutrostage2' => '
        <div class="clearfix">
            <p class="mb-2">
                Vos résultats indiquent que, bien que vous soyez en bonne voie dans votre parcours numérique, il existe également des domaines à aborder pour rattraper les entreprises ayant la meilleure maturité numérique. Ce rapport vous donnera des conseils sur les domaines à privilégier lorsque vous vous pencherez sur l\'étape suivante de la maturité numérique. Passons à la page suivante et penchons-nous sur ce que vous pouvez faire.
            </p>
        </div>
        <div class="pb"></div>
    ',
    'overalloutrostage3' => '
        <div class="clearfix">
            <p class="mb-2">
                Vos résultats indiquent que vous êtes en haut de la liste en matière de maturité numérique. Même si c\'est super, il peut y avoir des domaines dans lesquels vous devez faire attention à garder une longueur d\'avance. Ce rapport vous donnera des conseils sur les domaines sur lesquels vous devez vous concentrer. Passons à la page suivante et voyons ce que vous pouvez faire.
            </p>
        </div>
        <div class="pb"></div>
    ',
    ...
    'digital-business-intro' => '
        ...
        <div class="clearfix">
            ...
            <div class="w-4/5 float-left">
                <p class="mb-2">
                    Une entreprise de la catégorie Natif numérique crée et fournit des innovations rapidement, place les clients au cœur de son existence et considère les employés comme sa ressource la plus précieuse. Elle interagit avec son écosystème pour co-créer l\'innovation, accéder aux ressources et les partager. Pour déterminer à quel point votre entreprise est numérique, vous pouvez examiner la part de votre chiffre d\'affaires liée aux produits et services numériques, et la mesure dans laquelle votre entreprise dépend des outils numériques, la qualité du soutien que vous apportez à vos clients et à vos employés par le biais des canaux numériques et la façon dont vous interagissez avec votre écosystème de façon numérique.
                </p>
                <p class="mb-2">
                    Cette section du rapport évalue l\'étape de la maturité numérique de votre entreprise en fonction de la manière dont votre entreprise est numérique, de la manière dont vous gérez les changements de modèles commerciaux et de niveaux de personnel, des applications que vous utilisez et de la manière dont vous les déployez.
                </p>
            </div>
        </div>
    ',
    ...
    'digital-business-2-stage1' => '
        <div class="clearfix">
            <p class="w-4/5 ml-auto mb-2 text-dassault-blue font-bold">
                Votre score global pour cette section indique que vous êtes en retard par rapport à vos pairs du groupe Spécialiste numérique en ce qui concerne votre approche de l\'entreprise numérique. L\'entreprise numérique est un domaine que vous devez améliorer pour prendre contact avec vos pairs. Vous devez donc prendre des mesures pour accélérer le parcours dès maintenant. Vous devriez examiner les domaines d\'évaluation individuels de cette section pour comprendre les changements que vous pourriez éventuellement apporter à votre approche de l\'entreprise numérique afin d\'améliorer votre maturité numérique.
            </p>
        </div>
    ',
    ...
    'digital-business-3-stage2' => '
        <div class="clearfix">
            <p class="w-4/5 ml-auto mb-2 text-dassault-blue font-bold">
                Votre score global pour cette section indique que vous êtes en avance sur vos pairs dans le domaine Spécialiste du numérique par rapport aux progrès que vous avez réalisés. Bravo pour votre parcours jusqu\'à présent ! Tout en restant à jour, vous devez également examiner les aspects liés à la conception numérique et à la livraison numérique afin d\'améliorer votre maturité numérique globale.
            </p>
        </div>
    ',
    'digital-business-3-stage3' => '
        <div class="clearfix">
            <p class="w-4/5 ml-auto mb-2 text-dassault-blue font-bold">
                Votre score global dans ce domaine indique que vous êtes en phase avec les pairs du groupe Natif numérique par rapport aux progrès que vous avez réalisés en ce qui concerne votre approche de l\'entreprise numérique. Tout en restant à jour, vous pouvez examiner les domaines d\'amélioration, le cas échéant, liés à la conception numérique et à la livraison numérique, afin d\'améliorer votre maturité numérique globale.
            </p>
        </div>
    ',
    ...
    'question1' => '
        <div class="clearfix">
            <p class="w-4/5 ml-auto mb-2 font-bold text-dassault-blue-light">
                Q1. Dans quelle mesure votre entreprise a-t-elle du mal à faire face aux changements de modèles commerciaux ?
            </p>
        </div>
    ',
    'digital-business-1-q1-1' => '
        <div class="clearfix">
            <p class="w-4/5 ml-auto mb-2">
                Votre réponse indique que vous faites face aux fluctuations de votre activité de façon adaptée. Cela signifie que vous êtes bien en avance sur vos pairs du groupe Novice numérique pour permettre à votre entreprise de travailler numériquement. Bravo ! Vous devez maintenant concentrer vos efforts sur d\'autres domaines afin d\'améliorer votre maturité numérique globale.
            </p>
        </div>
    ',
    ...
    'digital-business-2-q1-1' => '
        <div class="clearfix">
            <p class="w-4/5 ml-auto mb-2">
                Votre réponse indique que vous faites face aux fluctuations de votre activité de façon adaptée. Cela signifie que vous êtes bien en avance sur vos pairs du groupe Spécialiste du numérique pour permettre à votre entreprise de travailler numériquement. Bravo ! Vous devez maintenant concentrer vos efforts sur d\'autres domaines afin d\'améliorer votre maturité numérique globale.
            </p>
        </div>
    ',
    ...
    'digital-business-3-q1-1' => '
        <div class="clearfix">
            <p class="w-4/5 ml-auto mb-2">
                Votre réponse indique que vous faites face aux fluctuations de votre activité de façon adaptée. Cela signifie que vous êtes à la hauteur de vos pairs du groupe Natif numérique dans le domaine de l\'optimisation numérique de votre entreprise. Bravo ! Vous devez maintenant concentrer vos efforts sur d\'autres domaines afin d\'affiner votre maturité numérique globale.
            </p>
        </div>
    ',
