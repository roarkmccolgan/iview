...
return array(
    ...
    'landing'=>'
        <p class="mb-2">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos, enim dolorem in, saepe vero impedit, nostrum ullam accusamus qui suscipit, a? Inventore maxime culpa dolores deserunt esse ex tempore aliquid.
        </p>',
    ...
    'byreg'=>'By registering with IDC, you accept our <a href="https://dassultdigitalfitness.idcready.net/privacy" target="_blank">Privacy Policy</a> and Dassault Systèmes, <a href="https://www.3ds.com/privacy-policy/" target="_blank">Privacy and Cookie Policy</a>.',
    ...
    'finishtxt' => '
        <h2 class="font-light leading-tight mb-4">Thank you for completing the Dassault Digital Fitness Capability Assessment</h2>
    ...
    'complete_body' => '
        ...
        <a class="btn btn--primary" target="_blank" href="http://www.google.com">
    ...
    'introduction' => '
        ...
        <h3 class="dassault-blue">Figure 1 – Next Generation WAN Assessment</h3>
    ...
    ',
    'overallintro'=>'
        <h2 class="text-dassault-blue mb-6">OVERALL PERFORMANCE</h2>
        <p class="mb-2">
    ...
    'digital-businessintro' => '
        <h2 class="w-2/3 ml-auto text-dassault-blue mb-6">WAN INFRASTRUCTURE</h2>
        <div class="clearfix">
    ...
    'digital-business-1-stage1' => '
        <div class="clearfix">
            <p class="w-2/3 ml-auto mb-2 text-dassault-blue font-bold">
    ...
    'digital-designintro' => '
        <h2 class="w-2/3 ml-auto text-dassault-blue mb-6">WAN INTELLIGENCE</h2>
        <div class="clearfix">
            <div class="w-1/3 float-left"><img class="block mx-auto" src=":icon" alt="" style="width: 25mm;"></div>
            <p class="w-2/3 float-left mb-2">
    ...
    'digital-deliveryintro' => '
        <h2 class="w-2/3 ml-auto text-dassault-blue mb-6">WAN OPERATIONS</h2>
        <div class="clearfix">
            <div class="w-1/3 float-left"><img class="block mx-auto" src=":icon" alt="" style="width: 25mm;"></div>
            <p class="w-2/3 float-left mb-2">
    ...
    'digital-delivery-1-stage1' => '
        <div class="clearfix">
            <p class="w-2/3 ml-auto mb-2 text-dassault-blue mt-4 font-bold">
    ...
    'conclusionintro' => '
        <h2 class="w-2/3 ml-auto text-dassault-blue mb-6">CONCLUSION</h2>
        <div class="clearfix">
            <div class="w-1/3 float-left"><img class="block mx-auto" src=":icon" alt="" style="width: 25mm;"></div>
            <p class="w-2/3 float-left mb-2">
    ...
    'guidance' => '
        <h2 class="w-2/3 ml-auto text-dassault-blue mb-6">Essential Guidance</h2>
        <div class="clearfix">
