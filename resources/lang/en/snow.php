...
return array(
    ...
    'introduction1' => '
        <div class="clearfix">
            <div class="w-3/4 ml-auto">
                <h2 class="text-snow-dark mb-2">Executive Summary</h2>
                <p class="mb-2">
                    This customized report is based on your answers to the IDC Agility Framwork Evaluation Survey that you recently completed.
                </p>
                <p class="mb-2">
                    We hope that by reading the report you will not only learn how far your Agility Framwork has taken you, but also inspire you to set new milestones and help you reach the next level of cloud maturity and thereby help your organization become more innovative, agile, and profitable.
                </p>
                <p class="mb-2">
                    The report presents your overall cloud assessment score and identifies your organization as a <strong class="text-snow-dark">Cloud Experimenter</strong>, a <strong class="text-snow-dark">Cloud Optimizer</strong>, or a <strong class="text-snow-dark">Cloud Innovator</strong>. It also breaks down the assessment score in three dimensions that all must be mastered to unlock the full potential of the cloud — the strategy to <strong class="text-gray-800">move</strong> the existing application estate to the cloud, the dedication to <strong class="text-gray-800">build</strong> new cloud-native applications, and the ability to <strong class="text-gray-800">manage</strong> and orchestrate the cloud resources to continuously ensure performance, compliance, and cost efficiency.
                </p>
            </div>
        </div>
        <div class="clearfix">
            <div class="mt-32 w-1/4 float-left p-1 text-snow-dark-light italic leading-tight">
                Nordic organisations\' main business priorities are innovation, customers and cost optimisation
            </div>
            <div class="w-3/4 float-left">
                <h2 class="text-snow-dark mb-2 mt-6">Market Context and Key Drivers</h2>
                <p class="mb-2">
        ...
        <div class="clearfix">
            <div class="w-1/4 float-left p-1 text-snow-dark-light italic leading-tight">
    ...
    'introduction2' => '
        <div class="clearfix w-3/4 ml-auto">
            <h2 class="text-snow-dark mb-2">Best-in-Class Cloud (Nirvana)</h2>
            <p class="mb-2">
    ...
    'introduction3' => '
        <div class="clearfix w-3/4 ml-auto">
            <h2 class="text-snow-dark mb-2 mt-6">Three Dimensions of Cloud Mastery</h2>
            <h3 class="text-snow-dark mb-2">Move</h3>
            <p class="mb-2">
            ...
            <h3 class="text-snow-dark mb-2">Build</h3>
            <p class="mb-2">
            ...
            <h3 class="text-snow-dark mb-2">Manage</h3>
            <p class="mb-2">
    ...
    'introduction4' => '
        <div class="clearfix w-3/4 ml-auto">
            <h2 class="text-snow-dark mb-2">Your Ranking Overall</h2>
    ...
    'overallstage1'=>'
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Overall Score</h3>
            <p class="mb-4 font-bold">
                Based on your responses, your organization is categorized as a <span class="text-snow-dark">Cloud Experimenter</span>
            </p>
            <p class="mb-2">
        ...
        <div class="my-5 relative" style="width:160mm;height:75.79mm; background: url(:url) no-repeat; background-size:cover">
            <div class="bg-snow-dark absolute" style="width: :overall; height: 10mm; top:15mm; left:33mm;"></div>
        ...
        <div class="clearfix w-3/4 ml-auto">
            ...
            <p>
                This will enable you to control cost better, but more importantly to support the changing business requirements efficiently and flexibly. Moreover, it will accelerate the Agility Framwork.
            </p>
        </div>
    ',
    'overallstage2'=>'
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Overall Score</h3>
            <p class="mb-4 font-bold">
                Based on your responses, your organization is categorized as a <span class="text-snow-dark">Cloud Optimizer</span>
            </p>
            <p class="mb-2">
        ...
        <div class="my-5 relative" style="width:200mm;height:94.7mm; background: url(:url) no-repeat; background-size:cover">
            <div class="bg-snow-dark absolute" style="width: :overall; height: 13mm; top:18mm; left:43mm;"></div>
    ...
    'overallstage3'=>'
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Overall Score</h3>
            <p class="mb-4 font-bold">
                Based on your responses, your organization is categorized as a <span class="text-snow-dark">Cloud Innovator</span>
            </p>
            <p class="mb-2">
    ...
    'move-intro' => '
        <div class="clearfix">
            <div class="w-1/4 float-left">
                ...
                <div class="mt-20 p-1 pr-5 text-snow-dark-light italic leading-tight">Moving applications into a cloud environment, be it private or public cloud, is an important step in application modernization</div>
            </div>
            <div class="w-3/4 float-left">
                <h2 class="text-snow-dark mb-3">Move</h2>
    ...
    'move-1' => '
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Score</h3>
            <p class="mb-4 font-bold">
                Based on your response, your organization is categorized as a <span class="text-snow-dark">Cloud Experimenter</span>. This group is characterized by cloud usage limited to non-core applications. 
            </p>
        </div>
        <div class="">
            <img class="w-full" src=":url" alt="">
    ...
    'move-2' => '
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Score</h3>
            <p class="mb-4 font-bold">
                Based on your response, your organization is categorized as a <span class="text-snow-dark">Cloud Optimizer</span>. This group is characterized by wide-scale cloud usage, including some core applications.
            </p>
        </div>
        <div class="">
            <img class="w-full" src=":url" alt="">
    ...
    'move-3' => '
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Score</h3>
            <p class="mb-4 font-bold">
                Based on your response, your organization is categorized as a <span class="text-snow-dark">Cloud Innovator</span>. This group is characterized by comprehensive cloud usage and independence of cloud deployment models. You are using the cloud both to save costs but also as a platform for innovation.
            </p>
        </div>
        <div class="">
            <img class="w-full" src=":url" alt="">
    ...
    'build-intro' => '
        <div class="clearfix">
            <div class="w-1/4 float-left">
                <img class="block mx-auto" src=":icon" alt="" style="width: 30mm;">
                <div class="mt-20 p-1 pr-5 text-snow-dark-light italic leading-tight">Modern applications built in the cloud can leverage the benefits of the cloud to then capitalize on other innovative technologies such as AI</div>
            </div>
            <div class="w-3/4 float-left">
                <h2 class="text-snow-dark mb-3">Build</h2>
                <h3 class="mb-3">Introduction and Market Context</h3>
                <p class="mb-2">
        ...
        <div class="clearfix">
            <div class="w-1/4 float-left p-1 pr-5 text-snow-dark-light italic leading-tight">
    ...
    'build-1' => '
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Score</h3>
            <p class="mb-4 font-bold">
                Based on your response, your organization is categorized as a <span class="text-snow-dark">Cloud Experimenter</span>. This group is characterized by organizations that primarily rely on standard off-the-shelf applications and have very few cloud-native applications.
            </p>
        </div>
        <div class="">
            <img class="w-full" src=":url" alt="">
    ...
    'build-2' => '
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Score</h3>
            <p class="mb-4 font-bold">
                Based on your response, your organization is categorized as a <span class="text-snow-dark">Cloud Optimizer</span>. This group is characterized by wider cloud-native application development. However, there are still some inconsistencies, and the cloud capabilities are not yet enterprisewide.
            </p>
        </div>
        <div class="">
            <img class="w-full" src=":url" alt="">
    ...
    'manage-intro' => '
        <div class="clearfix">
            <div class="w-1/4 float-left">
                <img class="block mx-auto" src=":icon" alt="" style="width: 30mm;">
                <div class="mt-10 p-1 pr-5 text-snow-dark-light italic leading-tight">The granularity of the architecture allows for comprehensive cost optimization, but the main value is in the agility and faster time-to-market that enhances business agility and resiliency.</div>
            </div>
            <div class="w-3/4 float-left">
                <h2 class="text-snow-dark mb-3">Manage</h2>
                <h3 class="mb-3">Introduction and Market Context</h3>
                <p class="mb-2">
        ...
        <div class="clearfix">
            <div class="w-1/4 float-left">
                <div class="p-1 pr-5 text-snow-dark-light italic leading-tight">legacy and fragmentation have not been fully addressed and still obstruct optimal use of cloud resources and constrain the extent and pace of the business\' digital transformation journey</div>
            </div>
            <div class="w-3/4 float-left">
                <p class="mb-2">
    ...
    'manage-1' => '
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Score</h3>
            <p class="mb-4 font-bold">
                Based on your response, your company is categorized as being a <span class="text-snow-dark">Cloud Experimenter</span>.
            </p>
            <p class="mb-2">
    ...
    'manage-2' => '
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Score</h3>
            <p class="mb-4 font-bold">
                Based on your response, your company is categorized as being a <span class="text-snow-dark">Cloud Optimizer</span>.
            </p>
            <p class="mb-2">
    ...
    'manage-3' => '
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-snow-dark mb-2">Your Score</h3>
            <p class="mb-4 font-bold">
                Based on your response, your company is categorized as being a <span class="text-snow-dark">Cloud Innovator</span>.
            </p>
            <p class="mb-2">
    ...
    'conclusion' => '
        <div class="clearfix pt-10">
            ...
            <div class="w-3/4 float-left">
                <h2 class="text-snow-dark mb-3">Conclusion</h2>
                <p class="mb-2">
                ...
                <ul classs="list-disc ml-10">
                    <li class="font-base text-snow-dark-light mb-1">Adopt a cloud-first architecture leveraging containers, microservices, APIs, functions, etc.</li>
                    <li class="font-base text-snow-dark-light mb-1">Assess your application estate and establish a road map of which applications to modernize and how </li>
                    <li class="font-base text-snow-dark-light mb-1">Focus on business outcomes beyond cost and cost structures, such as innovation and time to market</li>
                    <li class="font-base text-snow-dark-light mb-1">Confront your legacy and break down existing silos in IT systems, organizational structures, and skills requirements</li>
                    <li class="font-base text-snow-dark-light mb-1">Embrace a continuous approach, constantly evaluating technologies, reassessing modernization road maps, and orchestrating workloads across multiple platforms</li>
                </ul>
                <p class="mb-2">
                    If you want to know more about the role of cloud, especially multicloud and hybrid cloud, in application development and modernization as well as digital transformation, please check out the following report: <a href=":url" class="font-bold text-snow-dark">please click here</a>
                </p>
            </div>
        </div>
            ...
            <div class="w-1/3 float-left">
                <a href=":webinar1url" class="block p-1 no-underline">
                    <div class="p-2 border rounded">
                        ...
                        <p class="text-snow-dark font-bold">Move Webinar</p>
                    </div>
                </a>
            </div>
            <div class="w-1/3 float-left">
                <a href=":webinar2url" class="block p-1 no-underline">
                    <div class="p-2 border rounded">
                        ...
                        <p class="text-snow-dark font-bold">Build Webinar</p>
                    </div>
                </a>
            </div>
            <div class="w-1/3 float-left">
                <a href=":webinar3url" class="block p-1 no-underline">
                    <div class="p-2 border rounded">
                        ...
                        <p class="text-snow-dark font-bold">Manage Webinar</p>
                    </div>
                </a>
            </div>
        </div>
