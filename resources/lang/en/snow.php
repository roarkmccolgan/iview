...
return array(
    ...
    'finishtxt' => '
        ...
        <p class="mb-4">Based on your input, your aggregate score means that you are at the level of a <strong class="font-bold text-2xl text-snow-light">:stage</strong>.</p>
    ...
    'email'=>[
        ...
        'hi' => 'Hi :Fname',
        'body' => 'As promised, here\'s a link to download your IDC\'s Agility Framwork Assessment Report sponsored by ServiceNow. This breaks down your results by category and provides you with actionable recommendations.',
        'link' => 'Download PDF Report',
        'link_inline' => 'View Report in your browser',
        'extra' => '
            Once you\'ve read the report why not visit ServiceNow <a href="https://www.servicenow.com/">Click here</a><br/><br/>
            If you would like to contact someone directly about your Agility Framwork please contact John Doe at ServiceNow using the details below:<br/><br/>
            <strong>John Doe</strong><br>
            Business Development Specialist, ServiceNow<br/>
            Linkedin: <a href="https://www.linkedin.com/">www.linkedin.com/</a><br/>
            Phone: <a href="tel:+4687936069">+1 123 456 7890</a><br/>
            E-mail: <a href="mailto:john.doe@ServiceNow.com">john.doe@servicenow.com</a>
        ',
        'regards' => 'Regards',
        'team' => 'The IDC Team'
    ],
    ...
    'leadership' => [
        ...
        'color' => 'green',
        'common1' => [
            'IDC research found that 90% of CEOs consider agility to be critical to their organization\'s future success. ',
            'Agile organizations require a new and fundamentally different kind of leadership. Whereas traditional leadership has focused on planning, directing, and controlling the organization, agile leadership is all about envisioning, architecting, and coaching.',
        ...
        'stage3' => [
            ...
            'recommendations' => [
                'Move strategy formulation, strategy communication, and budgeting processes from being periodic to continuous. Retain some level of annual planning but wrap into this the idea of assessing that plan or forming smaller tweaks and changes at regular intervals throughout the year.',
        ...
        'stage4' => [
            ...
            'para' => [
                'Leadership in your organization assumes that change and disruptions are not anomalies, but rather a new industry reality. In response, the organization embraces change, while at the same time making significant attempts to preserve efficiency wherever possible.',
                'Strategy sets a direction but is only periodically reviewed. It continues to be based on financial and operational data, as well as on new developments in the industry and organization. Agile budgeting approaches are deployed, enabling you to fast-track important initiatives and to adjust for changed conditions.',
                'Leaders are starting to look across departments to enable process change and make selective investments in training and technologies to support these changes. The overall assumption is that the pace of disruption and change is accelerating, and that the organization must adapt to that reality.',
                'While things are looking on track, there are still further agility-enabling measures that can be created. IDC has identified some quick-win focus areas to drive greater agility into your culture and leadership vision.'
            ],
            'recommendations' => [
                ...
                'Leverage internal crowdsourcing and hackathons to drive continuous innovation and experimentation so that innovation and new ways of doing things become part of the organization culture.',
                'Leverage internal coaches to make sure people feel part of this overall strategy. You need to build ownership of the plan into every employee and ensure they feel part of the process — and the outcome.'
            ]
        ],
        'stage5' => [
    ...
    'structural' => [
        ...
        'stage2' => [
            ...
            'para' => [
                'Organizations at this stage in their structure agility journey have some form of communication and information sharing, but it is too often driven by a single department. When change does happen, it happens in silos, and impacts are not replicated or scaled, limiting their impact. This type of disconnected structure too often leads to internal disruption, discontent, and missed opportunities.',
                'One area of concern is the limited information gathered from employees. As a result, ideas on ways to improve individual roles and the organization overall are lost or worst case ignored. This tends to go hand in hand with a yearly planning cycle, which is used to assess skills and resource gaps. Too often, this is the only opportunity to recruit externally and gives little room for horizontal movement. Again, this fosters an even greater feeling of silos and disconnected departments.',
                'In response, IDC has identified some quick-win areas to address these critical and immediate requirements.'
            ],
            'recommendations' => [
                'Move from a disconnected structural approach to one that is inclusive and representative. Look to replicate this success and break down silos. This will also enhance employee engagement.',
        ...
        'stage3' => [
            ...
            'para' => [
                'Organizations at this stage are typically aware of the challenges stemming from their existing organizational structure and many will be in the process of addressing it. Increasing cooperation between departments and breaking down of pre-existing silos is likely to be a central theme and many are using tools and platforms to ensure companywide sharing of information, knowledge, best practices, and task assignment. ',
                'Teams are often formed around specific projects and bring together people from different functions with different skills and expertise. This drives a greater awareness of skills gaps and more frequent planning of resources based on emerging needs.',
                'Despite your best efforts, pockets of resistance likely remain. Often these are due to difficulty in executing transformation initiatives, but they may also be the result of a lack of proper technology tools. Moving forward, it is crucial to identify the reasons behind this delay in transforming the organizational structure. IDC has identified some quick-win areas to address these requirements.'
            ],
            'recommendations' => [
                'There is no one-size-fits-all approach to dealing with pockets of resistance or challenges in scaling toward a more agile structure. Work closely with the team and managers in question to determine what is preventing them from adjusting to the new structure. Explain the vision in more detail and act toward a solution in line with your stated goals.',
                ...
                'Work with HR and managers to get a full view of the needs and strengths of employees. Evaluate project success and customer satisfaction and how they relate to measuring employee performance.'
            ]
        ],
        'stage4' => [
            'title' => 'Synchronized Organizational Structure',
            'para' => [
                'Organizations at this stage regularly exhibit a structure that is flexible, adjustable, and well-integrated. The key characteristics here are clarity of scope and vision, close alignment between planning and execution, enhanced inclusion, and efficient use of resources. The organization has simple, yet comprehensive reporting structures, aided by systems of intelligence. It also frequently incorporates feedback and inputs to achieve an even higher level of efficiency. Transparency and trust have become a major part of how the organization delivers business outcomes across teams in a scalable fashion.',
                'Organizations at this stage typically have faster reaction times to change and can rely on teams shifting talent to where and when it is most needed. Continuous skills development and allocation are key aspects of organizations\' ability to react to changes and knowledge management. Collaborative activity is encouraged and formally monitored through KPIs.',
                'For the future, there is more that can be done to complete the transformation in pursuit of a fully fluid organizational structure. IDC has identified some quick-win areas to address these requirements.'
            ],
            'recommendations' => [
                ...
                'Experiment with new organizational structures, including squads and tribes, and encourage people to spontaneously join them. Closely monitor impacts on behavior and adjust accordingly.',
        ...
        'stage5' => [
            ...
            'para' => [
                'At this level, your organization has managed to achieve a fluid, transparent, robust, and proactive structure. Such a structure enables your organization to manage external and internal challenges with relative ease. Stakeholders and management are always on top of the situation, and resources are recruited in real time — both internally and externally — to respond to continuous skills needs.',
                'Flexible cross-functional teams are spontaneously created as a new need arises and skills are developed continuously, based on changing market conditions, objectives, and personal aspirations. Teams work in a completely transparent and trusting manner — delivering ongoing outcomes in a scalable fashion. ',
                'You have most likely deployed real-time information sharing structures that collect, analyze, and disseminate internal and external feedback. Your tools and infrastructure are at the cutting edge and the processes built around them enable your organization to be ahead of the curve at every turn. You need to keep moving forward, and IDC has identified some recommendations that will ensure that your fluid organizational structure will remain a key competitive advantage.'
            ],
            'recommendations' => [
                'Sustain this momentum by rewarding best practices, knowledge sharing, and life-long learning — making this part of the company fabric and key to attracting and retaining the best talent. ',
                'Prioritize employee engagement and continuous talent development by fostering a learning culture that pushes employees to become more digital-savvy, curious, and likely to experiment.',
    ...
    'process' => [
        ...
        'common1' => [
            ...
            'A digitally mature organization has clearly defined end-to-end processes. It has digitized them, creating workflows that are cross-functional or even cross-organizational in nature, while ensuring all systems in the value chain are fully integrated. All processes are complementary, working in synergy, and are automated to capture, process, analyze, and deliver results in a highly effective and efficient manner.'
        ],
        ...
        'stage2' => [
            ...
            'para' => [
                'Organizations at this stage in their process agility journey have made some improvements and achieved some level of standardization, but this is typically within the silos of specific functions.',
                'As a result, effective cross-functional integration is unlikely to have been achieved and processes may be too complex and rigid to support agile performance. They are also likely to be tied to an ERP system that may have been implemented some time back.',
                'Even though standardization of some key processes may have removed the duplication of tasks, bottlenecks and inefficiencies remain in the processes that link one department or function to another. You and your organization stand to gain a great deal of value from defining optimum workflows, digitizing your processes, and improving cross-functional integration.',
                'By making improvements to your processes, you will find immediate efficiency gains, enabling your teams to focus on more strategic tasks, and by becoming more responsive to both customers and internal dynamics. IDC has highlighted some key focus areas to drive your processes to the next level. ',
            ],
            'recommendations' => [
                ...
                'Create a cross-function approach to identify process bottlenecks at the intersections and eliminate them. Involve all the functions in this review but make sure to support this effort with a strong leadership sponsorship.',
        ...
        'stage5' => [
            ...
            'para' => [
                'IDC classifies your process maturity as agile. This is the highest level on our scale, so well done. Organizations at this stage in their process agility typically have standardized, fully digitized, and automated core processes. This enables new processes to be created by employees through self-service and ensures a level of integration between functions and departments that results in heightened efficiency, but also a wealth a data outputs that can be used to make key business decisions and real-time agile adjustments.',
                'Your processes likely extend beyond your organization to include stakeholders and wider ecosystem players. This manifests itself in customers, suppliers, distributors, and partners being part of the agile processes you have defined and becoming a key source of improvements. ',
            ...
            'recommendations' => [
                ...
                'Connect with your wider ecosystem to reach the next level of ecosystem process excellence. By improving the overall process maturity of your ecosystem, you move into a world of ecosystem-enabled business models and become a force against which only other ecosystem-enabled business models can compete. ',
    ...
    'portfolio' => [
        ...
        'stage1' => [
            ...
            'para' => [
                'Organizations at this stage typically have long development cycles, which may be determined by industry or sector. Either way, this may mean you are failing to react appropriately to changes in both market requirements and the external environment.',
                'This situation is likely due to many formal or semi-formal processes for collecting and distributing insight, as well as lengthy procedures for disseminating and acting on that insight. Your organization most likely has bottlenecks in process and approval, and these are likely to be holding up what would otherwise be rapid decision making.',
                'Also common among organizations at this stage is a failure to unwind underperforming elements of the portfolio. And even if this portfolio is narrow, the ability to further segment it and identify strong and weak areas of growth and opportunity may not be happening as well as it should. IDC has identified some key focus areas to help you drive greater agility into the portfolio element of your organization.'

            ],
            'recommendations' => [
                'Start collecting data on different customer requirements, segmented by region or customer type, or by external factors. This will lead the organization toward building variation on core elements in the future.',
        ...
        'stage2' => [
            ...
            'para' => [
                'Organizations at this stage in their portfolio agility may have developed the processes and capability to adapt products and services to external dynamics and requirements, but these processes take far too long. Your organization could be missing out or falling behind competitors.',
                'It is likely your organization is centered on major shifts in portfolio strategy and the key products and services that form the portfolio. As a result, you may not have the capability to make minor changes or variations, or the ability to address specific customer needs through advanced segmentation.',
            ...
            'recommendations' => [
                ...
                'Focus on the use of data and insight in determining your portfolio strategy. Is your approach driving a reactive and linear decision-making process? If so, can you automate data collection and use across the organization, so all departments can contribute to where the portfolio works and is also underdelivering?',
        ...
        'stage3' => [
            ...
            'para' => [
                'Organizations at the "in motion" stage of portfolio agility typically launch products and services annually or semiannually, as well as implementing updates and some changes and improvements throughout the year. Your senior management team must likely support this approach, but the cyclical process may be restricting the need for greater frequency, to take advantage of changing market requirements.',
                'You are most likely actively encouraging and collecting customer inputs, but again this is typically done on a systematic basis by individual departments rather than as an organizationwide decision. Insight may be held up centrally and not reach elements of the organization that can act on it and drive far more agility into the portfolio. Equally, such insight may not be actively used to make critical decisions on which parts of your portfolio to unwind or drop altogether.',
                'In response, IDC has formulated some key recommendations on how to reinvigorate your portfolio agility and ensure it takes advantage of other developments taking place across your organization.'
            ],
            'recommendations' => [
        ...
        'stage4' => [
            ...
            'recommendations' => [
                'Moving to the next stage requires intelligent systems that analyze historic data to anticipate future customer needs, as well as manage this through finance, operations, and customer services. Anticipating agility requirements is a sign of maturity in agile portfolio management.',
                ...
                'Look to the creation or refinement of a customer platform that transforms real-time data into automatic alerts and actions across the organization. This requires an integrated approach to delivering on customer requirements and much better communication across the organization.'
            ]
        ],
        'stage5' => [
    ...
    'technology' => [
        ...
        'stage2' => [
            ...
            'para' => [
                'Organizations at Stage 2 in their technology architecture agility typically have an IT environment that is predominantly on-premises, with a few software-as-a-service or custom applications in external clouds. Digital innovation is carried out in individual teams, without coordination across the organization.',
                'In innovation islands, "local" data (e.g., digital product usage) and third-party data drives intelligent features in products and processes. Where intelligence is embedded in operations, it is at a task-level automation with a strong focus on cost reduction. Business intelligence is used for reporting and analysis purposes, but this does not always result in business actions.',
                'Most integration efforts are typically focused on enabling standalone "stacks" of technology to support individual digital projects. You are also likely to have early examples of teams investing in agile application development, but these DevOps initiatives are typically project focused, and teams rarely share best practices.',
                'To sharpen the focus in your next steps to a more agile future, IDC has outlined some key recommendations for greater technology architecture agility.'
            ],
            'recommendations' => [
                ...
                'Promote process standardization to enable seamless service delivery from multiple interfaces and channels. Bake this into your approaches moving forward, rather than thinking about it as a nice to have.'
            ]
        ],
        'stage3' => [
            'title' => 'In-Motion Technology Architecture',
            'para' => [
                'At Stage 3, organizations are typically running technology architectures divided into two blocks: an advanced digital stack (or stacks) facing the outer world, and a more traditional "core" (mostly on-premises) running back-office processes. Your organization probably runs a multitude of cloud applications, but they are linked to traditional IT systems via APIs.',
                'Some cross-functional intelligence is available, and IT automation is expanding to your key processes including infrastructure and application provisioning. Enhanced standardization across services and frameworks enables you to deliver digital innovations through different interfaces and channels, including self-service portals.',
                'The time-to-market and software quality improvement benefits of DevOps are recognized throughout, and your IT operations teams are looking for ways to innovate in parallel to deliver resources faster in the "core." On the developer front, investments in CI/CD (continuous integration/continuous deployment) software are meant to accelerate innovation.',
                'To sharpen the focus in your next steps to a more agile future, IDC has outlined some key recommendations for greater technology architecture agility.',
            ],
            'recommendations' => [
                'Speed is the name of the game, but to make the leap you should start defining a single enterprise app, platform, and data integration strategy around adaptability. Everyone in the organization — and not just developers — should have the tools to adapt their workflows.',
                'Bring developers and IT operation teams together, building a road map to move more and more IT system management into the DevOps responsibility, while maintaining the right governance.',
                'Move beyond analytics toward insights-driven proactivity. You should look to unlock software functions that proactively trigger interactions with employees and customers based on intelligence gathered. To do that, linkage between data repositories (from supply chain to customer support) will need to be frictionless.'
            ]
        ],
        'stage4' => [
            'title' => 'Synchronized Technology Architecture',
            'para' => [
                'Organizations with a synchronized technology architecture are at a stage where the digital stack and integrated "core" communicate natively. Data is seen as a business asset, with direct and indirect value. Organizations at this stage use intelligent automation in increasingly cross-functional ways, and processes can be easily accelerated through software. This cuts across HR, IT, customer support, and other departments.',
                'It is also likely that your systems can take prescriptive and predictive actions autonomously based on internal processes. An enterprisewide integration based on a common platform and set of architectural patterns is now truly strategic.',
                'Best practices are communicated across teams and a more inclusive approach to technology governance enables the tensions between "old/slow" and "new/fast" centers of power to be successfully navigated. Teams have achieved continuous delivery and continuous testing ensuring successful production deployments that have elastic scalability.',
                'While you are reaching a level of agile maturity, there are several next steps to a more agile future. IDC has outlined some key recommendations for greater technology architecture agility.'
            ],
            'recommendations' => [
                ...
                'Standardize a design and implementation approach for creating "digital feedback loops," creating insights from those and then driving changes and improvements into processes, products, services, and decisions.',
        ...
        'stage5' => [
            ...
            'para' => [
                'Your organization is in a lead position when it comes to technology architecture agility. You have a truly integrated architecture with intelligent systems at its core that supports automated workflows and DevOps strategies.',
                'It is likely that digital intelligence is seen as a core strategic capability and you strive to place digital intelligence at the heart of collaboration. This creates a collective intelligence where machines and people work together to streamline key decision-making processes and employees are accustomed to receiving proactive support through natural language interfaces and self-service portals.',
                ...
                'While you have reached significant levels of maturity, agility is continuous. IDC has outlined some key recommendations for greater technology architecture agility.'
