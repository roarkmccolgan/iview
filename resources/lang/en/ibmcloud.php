...
return array(
    ...
    'complete_body' => '
        ...
        <a class="text-ibm-blue" target="_blank" href=":url">
    ...
    'introduction1' => '
        <div class="clearfix">
            <div class="w-3/4 ml-auto">
                ...
                <p class="mb-2">
                    This customized report is based on your answers to the IDC Cloud Journey Evaluation Survey that you recently completed.
                </p>
                <p class="mb-2">
                ...
                <p class="mb-2">
                    The report presents your overall cloud assessment score and identifies your organization as a <strong class="text-ibm-blue">Cloud Experimenter</strong>, a <strong class="text-ibm-blue">Cloud Optimizer</strong>, or a <strong class="text-ibm-blue">Cloud Innovator</strong>. It also breaks down the assessment score in three dimensions that all must be mastered to unlock the full potential of the cloud — the strategy to <strong class="text-gray-800">move</strong> the existing application estate to the cloud, the dedication to <strong class="text-gray-800">build</strong> new cloud-native applications, and the ability to <strong class="text-gray-800">manage</strong> and orchestrate the cloud resources to continuously ensure performance, compliance, and cost efficiency.
                </p>
            </div>
        </div>
        <div class="clearfix">
            <div class="mt-32 w-1/4 float-left p-1 text-ibm-blue-light italic leading-tight">
        ...
        <div class="clearfix">
            <div class="w-1/4 float-left p-1 text-ibm-blue-light italic leading-tight">
    ...
    'move-intro' => '
        <div class="clearfix">
            <div class="w-1/4 float-left">
                ...
                <div class="mt-20 p-1 pr-5 text-ibm-blue-light italic leading-tight">Moving applications into a cloud environment, be it private or public cloud, is an important step in application modernization</div>
            </div>
            <div class="w-3/4 float-left">
    ...
    'move-1' => '
        <div class="clearfix w-3/4 ml-auto">
            ...
            <p class="mb-4 font-bold">
                Based on your response, your organization is categorized as a <span class="text-ibm-blue">Cloud Experimenter</span>. This group is characterized by cloud usage limited to non-core applications. 
            </p>
        </div>
        <div class="">
            <img class="w-full" src=":url" alt="">
    ...
    'build-intro' => '
        <div class="clearfix">
            <div class="w-1/4 float-left">
                <img class="block mx-auto" src=":icon" alt="" style="width: 30mm;">
                <div class="mt-20 p-1 pr-5 text-ibm-blue-light italic leading-tight">Modern applications built in the cloud can leverage the benefits of the cloud to then capitalize on other innovative technologies such as AI</div>
            </div>
            <div class="w-3/4 float-left">
        ...
        <div class="clearfix">
            <div class="w-1/4 float-left p-1 pr-5 text-ibm-blue-light italic leading-tight">
    ...
    'build-2' => '
        <div class="clearfix w-3/4 ml-auto">
            <h3 class="text-ibm-blue mb-2">Your Score</h3>
            <p class="mb-4 font-bold">
                Based on your response, your organization is categorized as a <span class="text-ibm-blue">Cloud Optimizer</span>. This group is characterized by wider cloud-native application development. However, there are still some inconsistencies, and the cloud capabilities are not yet enterprisewide.
            </p>
        </div>
        <div class="">
            <img class="w-full" src=":url" alt="">
    ...
    'manage-intro' => '
        <div class="clearfix">
            <div class="w-1/4 float-left">
                <img class="block mx-auto" src=":icon" alt="" style="width: 30mm;">
                <div class="mt-10 p-1 pr-5 text-ibm-blue-light italic leading-tight">The granularity of the architecture allows for comprehensive cost optimization, but the main value is in the agility and faster time-to-market that enhances business agility and resiliency.</div>
            </div>
            <div class="w-3/4 float-left">
        ...
        <div class="clearfix">
            <div class="w-1/4 float-left">
                <div class="p-1 pr-5 text-ibm-blue-light italic leading-tight">legacy and fragmentation have not been fully addressed and still obstruct optimal use of cloud resources and constrain the extent and pace of the business\' digital transformation journey</div>
            </div>
            <div class="w-3/4 float-left">
                <p class="mb-2">
        ...
        <div class="clearfix pt-10">
            ...
            <div class="w-3/4 float-left">
                ...
                <ul classs="list-disc ml-10">
                    ...
                    <li class="font-base text-ibm-blue-light mb-1">Focus on business outcomes beyond cost and cost structures, such as innovation and time to market</li>
            ...
            <div class="w-1/3 float-left">
                <a href=":webinar1url" class="block p-1 no-underline">
                    <div class="p-2 border rounded">
                        ...
                        <p class="text-ibm-blue font-bold">Move Webinar</p>
                    </div>
                </a>
            </div>
            <div class="w-1/3 float-left">
                <a href=":webinar2url" class="block p-1 no-underline">
                    <div class="p-2 border rounded">
                        ...
                        <p class="text-ibm-blue font-bold">Build Webinar</p>
                    </div>
                </a>
            </div>
            <div class="w-1/3 float-left">
                <a href=":webinar3url" class="block p-1 no-underline">
                    <div class="p-2 border rounded">
                        ...
                        <p class="text-ibm-blue font-bold">Manage Webinar</p>
                    </div>
                </a>
            </div>
        </div>
