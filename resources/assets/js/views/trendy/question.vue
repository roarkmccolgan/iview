...
//Question components
import QuestionButton from '../../components/trendy/QuestionButton.vue';
import QuestionSlider from '../../components/trendy/QuestionSlider.vue';
import GroupSlider from '../../components/trendy/GroupSlider.vue';
...
export default{
	data () {
		return {
			...
			disabledButton: 'block w-full py-4 px-4 text-center bg-trend-red text-white opacity-50 cursor-not-allowed',
			error: false,
