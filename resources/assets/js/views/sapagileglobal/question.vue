<template>
	<div class="flex-1 bg-grey-lighter">
		<div class="flex flex-col">
			<div class="bg-cover bg-no-repeat bg-blackblack bg-center" :style="`background-image: url(/images/tools/17/${currentQuestion.section}-bg.png);`">
			...
			<div class="container mx-auto pt-2 text-grey-darkest px-4">
				<span class="text-sm hidden sm:block sm:my-2">{{ $t('general.question') | toTitle}} {{currentQuestion.name}} {{$t('general.of')}} {{totalQuestions}} - {{ $t('sapagileglobal.'+currentQuestion.section+'.title') }} </span>
...
//Question components
import QuestionButton from '../../components/sapagileglobal/QuestionButton.vue';
import QuestionSlider from '../../components/sapagileglobal/QuestionSlider.vue';
import GroupSlider from '../../components/sapagileglobal/GroupSlider.vue';
import GroupButton from '../../components/sapagileglobal/GroupButton.vue';
import GroupOpposingSlider from '../../components/sapagileglobal/GroupOpposingSlider.vue';
