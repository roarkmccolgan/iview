					...
					<div class="sm:ml-8">
						...
						<!-- <form id="leadForm" :action="'/'+assessment.localeUrl+'pdf'" method="GET" > -->
							...
							<h2 class="flex justify-start p-2 bg-grey-darker text-white font-light leading-tight">
								...
								<div v-html="$t('sapagile.register')"></div>
							</h2>
									...
									<div class="ml-2">
										...
										<div class="inline-block relative w-full mb-2">
											<select class="block appearance-none w-full bg-grey-lighter border text-grey-darker py-3 px-4 pr-8 rounded" :class="[errors.size ? 'border-red' : '']" id="industry" name="extra[industry]" @blur="hasError">
												...
												<option value="Banking/insurance/financial services" v-html="$t('sapagile.industry1')"></option>
												<option value="Manufacturing" v-html="$t('sapagile.industry2')"></option>
												<option value="Retail/wholesale" v-html="$t('sapagile.industry3')"></option>
												<option value="Communication" v-html="$t('sapagile.industry4')"></option>
												<option value="Media (TV, radio, press)" v-html="$t('sapagile.industry5')"></option>
												<option value="Utilities" v-html="$t('sapagile.industry6')"></option>
												<option value="Transportation" v-html="$t('sapagile.industry7')"></option>
												<option value="Construction" v-html="$t('sapagile.industry8')"></option>
												<option value="Personal services/leisure" v-html="$t('sapagile.industry9')"></option>
												<option value="Professional services (real estate, accountancy, advertising, business consultancy, recruitment, etc.)" v-html="$t('sapagile.industry10')"></option>
												<option value="IT/telecom service providerse" v-html="$t('sapagile.industry11')"></option>
												<option value="Education" v-html="$t('sapagile.industry12')"></option>
												<option value="Healthcare" v-html="$t('sapagile.industry13')"></option>
											</select>
											<div class="pointer-events-none absolute pin-y pin-r flex items-center px-2 text-grey-darker">
												<svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
											</div>
