	...
	<div class="flex-grow bg-grey-lighter">
		<div class="px-4 flex flex-col">
			...
			<div class="container mx-auto py-2 text-dassault-blue ">
				<span class="text-sm text-dassault-blue-light hidden sm:block sm:my-2">{{ $t('general.question') | toTitle}} {{currentQuestion.name}} {{$t('general.of')}} {{totalQuestions}} - {{ $t('dassaultlean.'+currentQuestion.section+'.title') }} </span>
...
//Question components
import QuestionInput from '../../components/dassaultlean/QuestionInput.vue';
import QuestionButton from '../../components/dassaultlean/QuestionButton.vue';
import QuestionSlider from '../../components/dassaultlean/QuestionSlider.vue';
import GroupSlider from '../../components/dassaultlean/GroupSlider.vue';
import GroupButton from '../../components/dassaultlean/GroupButton.vue';
import GroupOpposingSlider from '../../components/dassaultlean/GroupOpposingSlider.vue';
