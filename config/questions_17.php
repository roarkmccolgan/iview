        ...
        'pages' => [
            ...
            'page2' => [
                ...
                'questions' => [
                    'q2'=>[
                        'type'=>'checkbox',
                        'question'=>'What type of information do you use for your planning? (select all that apply)',
                        'name'=> 2,
                        'options'=>[
                            [
                                'label'=>'Financial',
        ...
        'pages' => [
            'page1' => [
                ...
                'questions' => [
                    'q4'=>[
                        'type'=>'button',
                        'question'=>'How would you best describe your company’s processes? (such as order placement, invoicing, logistics, for example)',
                        'name'=> 4,
                        'options'=>[
                            [
        ...
        'pages' => [
            ...
            'page2' => [
                ...
                'questions' => [
                    'q8'=>[
                        'type'=>'button',
                        'question'=>'How easy is it for your company to adapt to new customer needs (such as variation in products and services, new product requirements, or delivery times, for example)?',
                        'name'=> 8,
                        'options'=>[
                            [
                                'label'=>'Very difficult ',
            ...
            'page3' =>[
                ...
                'questions' => [
                    'q9'=>[
                        'type'=>'button',
                        'question'=>'How quickly can you successfully implement and manage new customer requirements (adding new features, speeding up delivery times, providing different levels of service, for example)?',
                        'name'=> 9,
                        'options'=>[
                            [
