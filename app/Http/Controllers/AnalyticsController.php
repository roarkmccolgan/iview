...
class AnalyticsController extends Controller {
	...
	public function index()
	{
		...
		foreach($queries as $key=>$query){
			$other = [];
			if($query['dimensions']) $other['dimensions'] = $query['dimensions'];
			if($query['sort']) $other['sort'] = $query['sort'];
			if($query['max-results']) $other['max-results'] = $query['max-results'];
			if($query['filters']) $other['filters'] = $query['filters'];
